...
func BackType(kind string) string {
	fmt.Println()
	if strings.Contains(kind,"int") {
		return "int"
	}else if strings.Contains(kind,"varchar"){
		return "string"
	}else if strings.Contains(kind,"enum"){
		return "string"
	}else if strings.Contains(kind,"datetime"){
		return "Time"
	}else if strings.Contains(kind,"json"){
		return "string"
	}else {
		return "string"
	}
